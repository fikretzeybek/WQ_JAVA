package day20_MutableIimmutable;
...
DateTimeFormatter istenenSaatFormati = DateTimeFormatter.ofPattern("hh:mm a");

        System.out.println(ldt.format(istenenSaatFormati));// 09:58 AM
