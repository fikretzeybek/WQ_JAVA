...
public class F02_listIterator {
    ...
    public static void main(String[] args) {
        ...
        //biz iterator olusturdugumuzda, listenin basinda konumlanir
        // eger sondan basa dogru islem yapmak istiyorsak
        //önce iteratoru sona gondermeliyiz

        while (listIterator.hasNext()){
            listIterator.next();
        }

        //artik terator sona gittigi icin basa dogru istenen islemi yaparak gelebiliriz

        while (listIterator.hasPrevious()){

            System.out.print(listIterator.previous()+ " ");//2 7 6 5 2 4 3 1 0 4 7 9 2 6 5 3
            System.out.println("");
        }
        //tum elementleri 1 artirin
        //iterator ile bir isleme baslamadan once
        //iteratorun son olarak nerede oldugunu bilmeliyiz
