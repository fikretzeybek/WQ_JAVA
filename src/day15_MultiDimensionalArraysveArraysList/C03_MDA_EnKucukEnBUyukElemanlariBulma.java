...
public class C03_MDA_EnKucukEnBUyukElemanlariBulma {
    ...
    public static void enBuyukEnKucukElemanBul(int[][] arr){
        ...
        System.out.println("Array'deki en buyuk sayi : " + maxElement);// 9
        System.out.println("Array'deki en kucuk sayi : " + minElement);// 0
    }
}